...
var methods = {
  ...
  create: {
    ...
    availableOptions: ['parent', 'thread', 'author_email', 'author_name', 'state', 'author_url', 'date', 'ip_address', 'remote_auth']
  },
  details: {
    resource: 'posts',
    name: 'details',
  ...
  listPopular: {
    ...
    method: 'GET',
    requiredOptions: ['api_secret'],
    availableOptions: ['category', 'interval', 'thread', 'forum', 'related', 'limit', 'offset', 'query', 'include', 'order', 'access_token']
  },
  remove: {
    resource: 'posts',
    name: 'remove',
  ...
  vote: {
    ...
    name: 'vote',
    method: 'POST',
    requiredOptions: ['api_secret', 'vote', 'post', 'remote_auth'],
    availableOptions: []
  }
};
