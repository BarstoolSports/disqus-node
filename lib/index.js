...
function Disqus(options) {
  ...
  var Threads = container.get('Threads');
  ...
  this.config = {
     ...
     */
    api_url: (options.https ? 'https' : 'http') + '://disqus.com/api/3.0/',
  ...
  /**
   * ###### Threads
   * [API](/lib/api/threads.html) | [CLI](/lib/cli/threads.html) | [Disqus](https://disqus.com/api/docs/threads/)
   */
